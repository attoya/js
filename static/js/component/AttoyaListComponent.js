...
class AttoyaListComponent extends BaseComponent {
  ...
  archiveCompleteBlowout(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(AttoyaListComponent).archiveCompleteBlowout()', payload);
  ...
  discardCompleteBlowout(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(AttoyaListComponent).discardCompleteBlowout()', payload);
  ...
  saveComplete(event, payload, xhr, target) {
    ...
    this.console.ajax(this.get_class_name() + '(AttoyaListComponent).saveComplete()', payload);
